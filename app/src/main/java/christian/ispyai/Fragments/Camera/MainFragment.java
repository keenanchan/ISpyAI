package christian.ispyai.Fragments.Camera;
...
public class MainFragment extends Fragment
    ...
    public interface OnGuessListener {
        void onGuess(List<Tag> tags);
    }

    private OnGuessListener mCallback;
    ...
    public void onAttach(Context context) {
        ...
        try {
            mCallback = (OnGuessListener) getActivity();
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Button captureBtn = getView().findViewById(R.id.picture);
    ...
    private class ProcessImage implements Runnable {
        ...
        public void run() {
            ...
            new AI.AsyncClass(inputStream, mCallback).execute();
        }
